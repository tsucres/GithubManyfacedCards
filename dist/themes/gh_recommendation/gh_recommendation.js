...
function addSIfSeveral(num){
	return num > 1 ? "s" : "";
}
function addSIfSingular(num) {
	return num <=1 ? "s" : "";
}
function getIssuesURL(repoFullName) {
	return "https://github.com/" + repoFullName + "/issues?q=is%3Aissue+is%3Aopen"
}
